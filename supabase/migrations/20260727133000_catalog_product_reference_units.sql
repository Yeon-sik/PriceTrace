alter table public.catalog_products
  add column reference_unit integer not null default 100;

alter table public.catalog_products
  add constraint catalog_products_reference_unit_check
  check (reference_unit in (10, 100, 1000));
...
as $$
  ...
  eligible_catalog as (
    select catalog.id as catalog_product_id, catalog.standard_product_id, catalog.content_amount, catalog.content_unit, catalog.package_count, catalog.reference_unit
