...
export function categoryForProduct(productName: string): ProductCategory {
  ...
  if (/식빵|빵$|우동|국수|칼국수|파스타|투움바|부옴바|짜장|당면|라자냐|브리또|컵피자|피자|누룽지탕|볶음밥|밥알|포크&스크램블|텐동|햇반|떡국|부침|소시지|프랑크|로스트비프|어묵|쌈장|초장|케찹|케첩|솔트|양념|참치|야채사각|도시락김|곱창김|김$|골뱅이|폭립|밀크씨슬|모닝이즈백|그릭콩포트|스노우크랩킹|크림우동/.test(name)) return "식품";
