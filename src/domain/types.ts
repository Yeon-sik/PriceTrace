...
export interface PriceObservation { receiptId:string; storeProductCode:string; productName:string; storeLabel:string; observedAt:string; unitPriceKrw:number; quantity:number; }
