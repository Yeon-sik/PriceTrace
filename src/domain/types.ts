...
export interface Receipt { id:string; storeLabel:string; storeAddress?:string|null; storePhone?:string|null; retailChannel:RetailChannel; catalogNamespace:string|null; purchasedAt:string; transactionNumber:string; currency:"KRW"; totalPriceKrw:number; items:ReceiptItem[]; }
