...
export interface Database {
  public: {
    Tables: {
      ...
      price_observations: { Row: { id:string; user_id:string; store_product_id:string; receipt_item_id:string|null; catalog_product_id:string|null; observed_at:string; unit_price_krw:number; quantity:number; measurement_unit:string; location_label:string|null; attributes:Json; verification_status:"pending"|"verified"|"rejected"; verified_at:string|null; observation_kind:"receipt_purchase"|"standalone_purchase"; verification_basis:"source_evidence"|"manual_canonical_review"|null; currency:"KRW"; gross_price_krw:number|null; discount_price_krw:number|null; net_price_krw:number|null; observed_at_exact:string|null }; Insert: { id?:string; user_id:string; store_product_id:string; receipt_item_id?:string|null; catalog_product_id?:string|null; observed_at:string; unit_price_krw:number; quantity:number; measurement_unit?:string; location_label?:string|null; attributes?:Json; verification_status?:"pending"|"verified"|"rejected"; verified_at?:string|null; observation_kind?:"receipt_purchase"|"standalone_purchase"; verification_basis?:"source_evidence"|"manual_canonical_review"|null; currency?:"KRW"; gross_price_krw?:number|null; discount_price_krw?:number|null; net_price_krw?:number|null; observed_at_exact?:string|null }; Update: { catalog_product_id?:string|null; observed_at?:string; unit_price_krw?:number; quantity?:number; measurement_unit?:string; location_label?:string|null; attributes?:Json; verification_status?:"pending"|"verified"|"rejected"; verified_at?:string|null; observation_kind?:"receipt_purchase"|"standalone_purchase"; verification_basis?:"source_evidence"|"manual_canonical_review"|null; currency?:"KRW"; gross_price_krw?:number|null; discount_price_krw?:number|null; net_price_krw?:number|null; observed_at_exact?:string|null } };
