...
export interface Database {
  public: {
    Tables: {
      ...
      product_identity_candidates: { Row: { id:string; user_id:string; schema_version:"PRICETRACE_PRODUCT_CANDIDATE"; contract_version:"product-candidate.v1"; source_app:"pricetrace_ocr_app"; source_version:string|null; candidate_type:"retail_product"|"complimentary_side"|"meal_component_estimate"; client_key:string|null; product_name:string; brand:string|null; sub_brand:string|null; manufacturer:string|null; specification:string|null; content_amount:number|null; content_unit:string|null; package_count:number|null; variant:string|null; identifiers:Json; evidence:Json; provenance:Json; request_payload:Json; review_status:"pending"|"review_required"|"accepted"|"rejected"; review_reasons:string[]; possible_catalog_product_ids:string[]; verification_status:"unverified"; visibility:"private"; created_at:string; updated_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      product_candidate_authority_projections: { Row: { user_id:string; client_key:string; request_fingerprint:string; candidate_id:string|null; resolution_status:"catalog_product_reused"|"private_unverified_candidate_created"|"review_required"; catalog_product_id:string|null; standard_product_id:string|null; source_payload:Json; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      product_candidate_ingestion_contents: { Row: { user_id:string; request_fingerprint:string; candidate_id:string|null; response:Json; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      product_candidate_ingestion_requests: { Row: { user_id:string; idempotency_key:string; request_fingerprint:string; candidate_id:string|null; response:Json; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      purchase_price_sources: { Row: { id:string; user_id:string; schema_version:"purchase-price-observation.v4"; contract_version:"purchase-price.v4"; source_app:"pricetrace_ocr_app"; source_version:string|null; kind:"retail_purchase"|"restaurant_purchase"|"other"|"unknown"; purchase_kind:"retail"|"restaurant"|"other"|"unknown"; platform_name:string; platform_code:string|null; order_reference:string|null; order_status:"ordered"|"pending"|"paid"|"shipped"|"delivered"|"cancelled"|"refunded"|"unknown"; ordered_on:string|null; ordered_at_exact:string|null; payment_status:"pending"|"paid"|"cancelled"|"refunded"|"unknown"; payment_method:"card"|"bank_transfer"|"mobile_payment"|"points"|"mixed"|"unknown"; paid_on:string|null; paid_at_exact:string|null; currency:"KRW"; payment_total_price_krw:number|null; payment_items_subtotal_krw:number|null; payment_shipping_fee_krw:number|null; payment_discount_krw:number|null; seller_status:"confirmed"|"unknown"; seller_name:string|null; seller_branch_name:string|null; seller_source_namespace:string|null; seller_source_code:string|null; seller_business_kind:string|null; source_url:string|null; note:string|null; source_fingerprint:string; source_payload:Json; transaction_state:"settled"|"pending"|"cancelled"|"refunded"|"unknown"; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      purchase_price_source_lines: { Row: { id:string; user_id:string; purchase_source_id:string; line_ordinal:number; source_line_key:string; line_seller_status:"confirmed"|"unknown"; line_seller_name:string|null; line_seller_branch_name:string|null; line_seller_source_namespace:string|null; line_seller_source_code:string|null; line_seller_business_kind:string|null; product_client_key:string|null; product_name:string; option_text:string|null; merchant_sku:string|null; price_status:"itemized"|"ambiguous"|"unknown"; quantity:number|null; unit_price_krw:number|null; gross_price_krw:number|null; discount_price_krw:number|null; net_price_krw:number|null; product_id:string|null; store_product_id:string|null; catalog_product_id:string|null; standard_product_id:string|null; price_observation_id:string|null; restaurant_menu_manual_observation_id:string|null; observation_status:"created"|"not_created"; observation_reason:string|null; line_payload:Json; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      purchase_price_observation_ingestion_contents: { Row: { user_id:string; request_fingerprint:string; purchase_source_id:string; response:Json; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      purchase_price_observation_ingestion_requests: { Row: { user_id:string; idempotency_key:string; request_fingerprint:string; purchase_source_id:string; response:Json; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      ...
      restaurant_menu_manual_observations: { Row: { id:string; restaurant_id:string; restaurant_location_id:string; restaurant_menu_id:string; observed_on:string; unit_price_krw:number|null; quantity:number|null; total_price_krw:number|null; source_url:string|null; note:string|null; source_snapshot:Json; verification_status:"unverified"|"verified"|"rejected"; created_by:string; created_at:string; observation_kind:"manual_registration"|"standalone_purchase"; verification_basis:"source_evidence"|"manual_canonical_review"|null; currency:"KRW"; gross_price_krw:number|null; discount_price_krw:number|null; net_price_krw:number|null; observed_at_exact:string|null }; Insert: { id?:string; restaurant_id:string; restaurant_location_id:string; restaurant_menu_id:string; observed_on:string; unit_price_krw?:number|null; quantity?:number|null; total_price_krw?:number|null; source_url?:string|null; note?:string|null; source_snapshot:Json; verification_status?:"unverified"|"verified"|"rejected"; created_by:string; created_at?:string; observation_kind?:"manual_registration"|"standalone_purchase"; verification_basis?:"source_evidence"|"manual_canonical_review"|null; currency?:"KRW"; gross_price_krw?:number|null; discount_price_krw?:number|null; net_price_krw?:number|null; observed_at_exact?:string|null }; Update: Record<string, never> };
      standalone_price_observation_ingestion_requests: { Row: { user_id:string; idempotency_key:string; request_fingerprint:string; request_payload:Json; kind:"retail_purchase"|"restaurant_purchase"; observation_id:string; retail_price_observation_id:string|null; restaurant_menu_manual_observation_id:string|null; response:Json; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      ...
      verified_receipt_source_lines: { Row: { receipt_id:string; user_id:string; source_line_id:string; line_type:string; description:string|null; source_line_references:string[]; merchant_sku:string|null; quantity_value:number|null; quantity_unit:string|null; unit_price_amount_minor:number|null; gross_amount_minor:number; discount_amount_minor:number; tax_amount_minor:number; net_amount_minor:number|null; tax_rate_percent:number|null; food_service_role:string|null; applies_to_source_line_id:string|null; line_ordinal:number|null; product_id:string|null; store_product_id:string|null; catalog_product_id:string|null; restaurant_menu_id:string|null; created_at:string }; Insert: Record<string, never>; Update: Record<string, never> };
      ...
      price_observations: { Row: { id:string; user_id:string; store_product_id:string; receipt_item_id:string|null; catalog_product_id:string|null; observed_at:string; unit_price_krw:number|null; quantity:number|null; measurement_unit:string|null; location_label:string|null; attributes:Json; verification_status:"pending"|"verified"|"rejected"; verified_at:string|null; observation_kind:"receipt_purchase"|"standalone_purchase"; verification_basis:"source_evidence"|"manual_canonical_review"|null; currency:"KRW"; gross_price_krw:number|null; discount_price_krw:number|null; net_price_krw:number|null; observed_at_exact:string|null }; Insert: { id?:string; user_id:string; store_product_id:string; receipt_item_id?:string|null; catalog_product_id?:string|null; observed_at:string; unit_price_krw?:number|null; quantity?:number|null; measurement_unit?:string|null; location_label?:string|null; attributes?:Json; verification_status?:"pending"|"verified"|"rejected"; verified_at?:string|null; observation_kind?:"receipt_purchase"|"standalone_purchase"; verification_basis?:"source_evidence"|"manual_canonical_review"|null; currency?:"KRW"; gross_price_krw?:number|null; discount_price_krw?:number|null; net_price_krw?:number|null; observed_at_exact?:string|null }; Update: { catalog_product_id?:string|null; observed_at?:string; unit_price_krw?:number|null; quantity?:number|null; measurement_unit?:string|null; location_label?:string|null; attributes?:Json; verification_status?:"pending"|"verified"|"rejected"; verified_at?:string|null; observation_kind?:"receipt_purchase"|"standalone_purchase"; verification_basis?:"source_evidence"|"manual_canonical_review"|null; currency?:"KRW"; gross_price_krw?:number|null; discount_price_krw?:number|null; net_price_krw?:number|null; observed_at_exact?:string|null } };
    ...
    Functions: {
      ...
      submit_product_candidate_v1: {
        Args: { p_idempotency_key:string; p_candidate:Json; };
        Returns: Json;
      };
      ingest_verified_standalone_price_observation_v1: {
        Args: { p_idempotency_key:string; p_observation:Json; };
        Returns: Json;
      };
      ingest_verified_purchase_price_observation_v1: {
        Args: { p_idempotency_key:string; p_purchase:Json; };
        Returns: Json;
      };
